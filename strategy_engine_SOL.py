...
class StrategyState:
    ...
    def process_bar(
        ...
        if long_signal:
            buy_margin = account_value * self.params.buy_pct
            buy_amount = buy_margin * self.params.leverage
            if cash >= buy_margin:
        ...
        if short_signal:
            sell_margin = account_value * self.params.buy_pct
            sell_amount = sell_margin * self.params.leverage
